...
import {bounceSequence, composedPath, ContextIterator} from "./BouncedPath.js";
...
function isNativeType(type){
  console.log(type)
  const b = ["pointerdown", "pointermove", "pointerup"].indexOf(type) >= 0;
  console.log(b)
  return b;
}
...
EventTarget.prototype.dispatchEvent = function (e, root, composedPathIn) {
