...
export class DragMaybeReaction extends HTMLElement {
  ...
  attributeChangedCallback(name, oldValue, newValue) {
    if (newValue === null) {
      document.removeEventListener('mousemove', tryToDrag, true);
      document.removeEventListener('mouseup', cancelDragMaybe, true);
      document.removeEventListener('mousedown', cancelDragMaybe, true);
      document.removeEventListener('blur', cancelDragMaybe, true);
    } else {
      document.addEventListener('mousemove', tryToDrag, true);
      document.addEventListener('mouseup', cancelDragMaybe, true);
      document.addEventListener('mousedown', cancelDragMaybe, true);
...
export class DraggingReaction extends HTMLElement {
  ...
  attributeChangedCallback(name, oldValue, newValue) {
    if (newValue === null) {
      document.removeEventListener('mousemove', mousemoveToDrag, true);
      document.removeEventListener('mouseup', endDragging, true);
      document.removeEventListener('mousedown', cancelDragging, true);
      document.removeEventListener('blur', cancelDragging, true);
    } else {
      document.addEventListener('mousemove', mousemoveToDrag, true);
      document.addEventListener('mouseup', endDragging, true);
      document.addEventListener('mousedown', cancelDragging, true);
