...
function makeNativeShadow(el) {
  ...
  if(el instanceof HTMLAnchorElement || el instanceof HTMLDetailsElement || el instanceof HTMLHtmlElement)  //todo Htmlselect??
...
function assignedSlotGet() {                                 //todo untested
  return assignedSlotOG.get.call(this) || nativeShadows.get(this.parentNode)?.children[0] || null;
}
