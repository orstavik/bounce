...
EventTarget.prototype.addEventListener = function (type, cb, options) {
  ...
  const preventable = options instanceof Object && 'preventable' in options && !!options.preventable;//todo should we !!options.passive and !!options.once too?
...
function getPropagationRoot(target, event) {
