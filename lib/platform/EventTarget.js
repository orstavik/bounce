import {bounceSequence, composedPath, contextForElement, ContextIterator, PathIterator} from "./BouncedPath.js";
import {findNativeDefaultAction} from "./getNativeDefaultAction.js";
import {updateEvent, initEvent, preventDefaultOG, stopImmediatePropagationOG, composedPathOG, eventToState} from "./Event.js";
...
function onFirstNativeListener(e) {
  ...
  let innerMostTarget = composedPathOG.call(e)[0];
...
EventTarget.prototype.dispatchEvent = function (e, options) {
  ...
  initEvent(e, composedPath(this, root));
  const topMostContext = bounceSequence(this, root);
  if (prevented) topMostContext.prevented = true; //patch the before propagation begins prevented. currently, this doesn't work, but it should.
