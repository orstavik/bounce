...
describe('Custom dispatchEvent ', function () {
  ...
  it('basic, capture', function () {
    ...
    for (let node of targets)
      node.addEventListener("my-event", e => res += log(e, true, node), true);
...
`;
  ...
  it('basic, bubble', function () {
    let res = "";
    for (let node of targets)
      node.addEventListener("my-event", e => res += log(e, false, node), false);
    h1.dispatchEvent(new Event('my-event', {composed: true, bubbles: true}));
    const test =
...
`;
  ...
  it('basic, bubble, capture, at_target', function () {
    let res = "";
    for (let node of targets){
      node.addEventListener("my-event-bc", e => res += log(e, false, node), false);
      node.addEventListener("my-event-bc", e => res += log(e, true, node), true);
    }
    h1.dispatchEvent(new Event('my-event-bc', {composed: true, bubbles: true}));
